...
export const CallSheetView: React.FC<CallSheetViewProps> = ({
  ...
  return (
    <div className="p-3.5 space-y-4 overflow-y-auto h-full text-xs">
      {/* Sleek Integrated Single-Row Control Bar */}
      <div className="flex flex-wrap items-center justify-between gap-2.5 p-2 rounded-xl bg-card/60 border border-border/80 text-xs shadow-2xs">
        {/* Left: Filter Pills */}
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-secondary/80 p-0.5 rounded-lg border border-border/60 text-[11px]">
            <button
              ...
              className={cn(
                "px-2.5 py-0.5 rounded-md font-medium transition-all cursor-pointer",
                filterStatus === "all"
            ...
            <button
              ...
              className={cn(
                "px-2.5 py-0.5 rounded-md font-medium transition-all cursor-pointer flex items-center gap-1",
        ...
        <div className="flex items-center gap-2 flex-wrap ml-auto">
          {/* Search Box */}
          <div className="relative flex items-center min-w-[150px] sm:min-w-[190px]">
          ...
          <select
            ...
            title="排期批次排序方式"
          >
            <option value="default">默认场次序</option>
            <option value="shots_desc">镜数降序</option>
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-300 border border-emerald-500/40 text-xs font-semibold shadow-xs transition-all cursor-pointer shrink-0"
