...
export function SeriesBlueprintModal({ isOpen, onClose }: SeriesBlueprintModalProps) {
          ...
          {errorMsg && (
            <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg flex items-start gap-2.5 text-xs text-red-400">
              ...
              <button
                ...
                className="px-2 py-1 bg-red-500/20 hover:bg-red-500/30 text-red-300 rounded font-medium transition cursor-pointer"
              >
                去配置 Key
              </button>
            </div>
