...
const FULL_DEMO_SHOTS = [
  ...
  { order: 4, duration: 2.0, size: "medium_close_up", angle: "eye_level", mov: "static", subj: "墨客 (Moke)", act: "墨客停下脚步，右手单掌微展摆出咏春问手架势，雨水顺着黑色墨镜边缘滴落。" },
  { order: 5, duration: 2.0, size: "close_up", angle: "low_angle", mov: "push_in", subj: "特工银狐 (Agent Fox)", act: "特工银狐双目泛起红色扫描光圈，身形瞬间化作模糊残影暴起突进。" },
  { order: 6, duration: 1.5, size: "full_shot", angle: "eye_level", mov: "tracking_left", subj: "核心交锋 (Combat)", act: "两人在暴雨中短兵相接，拳风与格挡带起激荡的白色雨雾与撞击冲击波。" },
  { order: 7, duration: 1.5, size: "medium_shot", angle: "dutch_angle", mov: "pan_right", subj: "连环攻防 (Matrix Combat)", act: "倾斜机位快速摇移，墨客沉桥封手化解连环刺击，反手一记寸劲击退银狐。" },
  { order: 8, duration: 1.5, size: "extreme_close_up", angle: "eye_level", mov: "push_in", subj: "特工银狐受创", act: "特工银狐受到重击，面部仿生皮肤瞬间发生像素化数据撕裂闪烁。" },
  { order: 9, duration: 3.5, size: "medium_close_up", angle: "eye_level", mov: "arc_rotate", subj: "子弹时间 (Bullet Time)", act: "360度子弹时间慢动作环绕，墨客侧身避开撕裂空气的超音速弹道，水珠在空中静止悬停。" },
  { order: 10, duration: 2.0, size: "full_shot", angle: "low_angle", mov: "tilt_up", subj: "终极一击 (Finishing Strike)", act: "仰角机位上摇，墨客凌空踏步飞膝重重轰在特工银狐胸口，将其撞飞破门而入。" },
  { order: 11, duration: 2.5, size: "wide_shot", angle: "high_angle", mov: "pull_out", subj: "胜负已分 (Resolution)", act: "特工银狐倒在碎裂的茶楼门槛中化为绿色数据碎片消散，雨水逐渐平息。" },
  { order: 12, duration: 3.0, size: "extreme_wide_shot", angle: "eye_level", mov: "crane", subj: "黑客墨客背影 (Ending)", act: "镜头缓缓升起拉远，墨客收势独立于青石街道，头顶的红灯笼在雨夜霓虹中摇曳定格。" },
];
